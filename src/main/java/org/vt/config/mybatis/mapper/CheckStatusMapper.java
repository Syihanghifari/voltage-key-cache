...
public interface CheckStatusMapper {
    ...
    final String GET_CHECK_STATUS_BY_USERNAME = "SELECT * FROM check_status WHERE username = #{username}";
    ...
    List<CheckStatus> getAllCheckStatusByUsername (String username);
